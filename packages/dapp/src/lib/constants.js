...
export const chainUrls = {
    ...
    8787: {
        rpc: REACT_APP_DCC_RPC_URL.split(' '),
        explorer: 'https://explorer.decommerce.com',
        chainId: 8787,
        name: networkNames[8787],
    },
    56: {
