...
const ETH_DCC_BRIDGE_CONFIG = {
    ...
    foreignGraphName: 'https://foreignsubgraph.decommerce.com/subgraphs/name/test/rinkeby',
    homeGraphName: 'https://homesubgraph.decommerce.com/subgraphs/name/test/decommerce',
...
const RINKEBY_DCC_BRIDGE_CONFIG = {
    ...
    homeAmbAddress: '0xc24d67928ab6d17ca627dfD19F506581c35703Dd'.toLowerCase(),
    foreignGraphName: 'https://foreignsubgraph.decommerce.com/subgraphs/name/test/rinkeby',
    homeGraphName: 'https://homesubgraph.decommerce.com/subgraphs/name/test/decommerce',
    ambLiveMonitorPrefix: '',
    claimDisabled: false,
